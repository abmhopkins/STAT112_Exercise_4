...
```{r}
fav_plaes <- tibble(
  place = c("Boston Home", "Bukhara","Johannesburg Home", "Hilton College", 
            "Eton College", "Jon Simon's", "Macalester College",
            "Blossom Bar", "Grandma Anne and Papa's", "Grandma B's", "Indochin"),
  long = c(-71.1029932, ),
  lat = c(42.3218395, )
  )
```
